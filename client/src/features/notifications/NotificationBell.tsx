...
export const NotificationBell = () => {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open && (
        <div className="absolute right-0 top-11 z-50 w-80 max-h-96 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden bg-surface rounded-lg border border-border shadow-xl origin-top-right animate-dropdown-in">
